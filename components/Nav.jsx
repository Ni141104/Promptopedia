...
const Nav = () => {
  ...
  //We use useSession hook of next auth to get to know that user is logged in or not
...
console.log(session);
  return (
    <nav className="flex-between w-full mb-16 pt-3">
        ...
        <Image src="/assets/images/logo.svg" width={40} height={40} alt="promptopedia logo" className="object-contain"/>
